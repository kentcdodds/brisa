...
import generateUniqueVariableName from '@/build-process/2-entrypoints/3-client-pages/transpilation/generate-unique-variable-name';
import getComponentVariableNames from '@/build-process/2-entrypoints/3-client-pages/transpilation/get-component-variable-names';
import getPropsNames, {
  getPropNamesFromExport,
} from '@/build-process/2-entrypoints/3-client-pages/transpilation/get-props-names';
import getWebComponentAst from '@/build-process/2-entrypoints/3-client-pages/transpilation/get-web-component-ast';
import manageWebContextField from '@/build-process/2-entrypoints/3-client-pages/transpilation/manage-web-context-field';
import mapComponentStatics from '@/build-process/2-entrypoints/3-client-pages/transpilation/map-component-statics';
import getPropsOptimizations from '@/build-process/2-entrypoints/3-client-pages/transpilation/get-props-optimizations';
import AST from '@/utils/ast';
import skipPropTransformation from '@/build-process/2-entrypoints/3-client-pages/transpilation/skip-prop-transformation';
