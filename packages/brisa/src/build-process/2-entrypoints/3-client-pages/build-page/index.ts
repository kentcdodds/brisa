...
import clientBuildPlugin from '../transpilation';
...
import analyzeServerAst from '@/build-process/2-entrypoints/1-server-entrypoints/analyze-server-ast';
...
export default async function buildClientPage({
  pagePath,
  allWebComponents = {},
  pageWebComponents = {},
  integrationsPath,
