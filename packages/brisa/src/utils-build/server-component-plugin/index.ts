...
import replaceAstImportsToAbsolute from '@/utils-build/replace-ast-imports-to-absolute';
import { logWarning } from '@/utils/log/log-build';
import getDependenciesList from '@/utils-build/ast/get-dependencies-list';
...
import { isJSXIdentifier } from '@/utils-build/ast/jsx-helpers';
...
export const workaroundText = Bun.semver.satisfies(Bun.version, '>= 1.1.33')
  ...
  : `import { jsx, jsxs, jsxDEV, Fragment } from 'brisa/jsx-runtime';\n`;
...
export default function serverComponentPlugin(
  ...
  function traverseB2A(this: any, key: string, value: any) {
    ...
    if (
      ...
      const hasKey = key && (key?.name !== 'undefined' || key?.value);
