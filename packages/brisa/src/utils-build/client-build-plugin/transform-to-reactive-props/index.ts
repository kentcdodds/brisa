...
import generateUniqueVariableName from '@/utils-build/client-build-plugin/generate-unique-variable-name';
import getComponentVariableNames from '@/utils-build/client-build-plugin/get-component-variable-names';
import getPropsNames, {
  getPropNamesFromExport,
} from '@/utils-build/client-build-plugin/get-props-names';
import getWebComponentAst from '@/utils-build/client-build-plugin/get-web-component-ast';
import manageWebContextField from '@/utils-build/client-build-plugin/manage-web-context-field';
import mapComponentStatics from '@/utils-build/client-build-plugin/map-component-statics';
import getPropsOptimizations from '@/utils-build/client-build-plugin/get-props-optimizations';
import AST from '@/utils-build/ast';
import skipPropTransformation from '@/utils-build/client-build-plugin/skip-prop-transformation';
